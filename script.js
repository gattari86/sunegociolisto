...
const translations = {
    es: {
        ...
        problem_2_desc: 'Abriste la p\u00E1gina del estado, viste \u201CCertificate of Formation,\u201D y la cerraste. No est\u00E1s solo.',
        ...
        step_1_title: 'Cont\u00E1ctanos',
        step_1_desc: 'Escr\u00EDbenos por WhatsApp o llena el formulario en esta p\u00E1gina. Te respondemos en menos de 1 d\u00EDa h\u00E1bil.',
        step_2_title: 'Llamada de confirmaci\u00F3n',
        step_2_desc: 'Revisamos tu informaci\u00F3n, respondemos preguntas, y recogemos datos sensibles de forma segura.',
        ...
        faq_11_q: '\u00BFVa a afectar los impuestos de mi familia si abro una LLC?',
        faq_11_a: 'Una LLC de un miembro \u00FAnico en Texas no cambia c\u00F3mo declaras tus impuestos federales \u2014 se reporta en tu declaraci\u00F3n personal, igual que antes. Y el impuesto estatal de Texas (franchise tax)? La mayor\u00EDa de LLCs peque\u00F1as no deben nada: $0. Si tienes preguntas espec\u00EDficas sobre tu situaci\u00F3n fiscal, te recomendamos consultar con un contador.',
        faq_12_q: '\u00BFCu\u00E1l es la diferencia entre LLC y DBA? \u00BFCu\u00E1l necesito?',
        faq_12_a: 'Una LLC es una entidad legal \u2014 protege tus bienes personales y te da un EIN para abrir cuenta de banco y recibir pagos formales. Un DBA (nombre asumido) es solo un nombre comercial, no te da protecci\u00F3n legal. La mayor\u00EDa de nuestros clientes necesitan la LLC primero. Si tu negocio opera con un nombre diferente al de tu LLC, entonces tambi\u00E9n necesitas el DBA. Ejemplo: tu LLC es \u201CMaria Garcia LLC\u201D pero vendes como \u201CDelicias de Maria\u201D \u2014 ah\u00ED necesitas ambos.',
        faq_13_q: '\u00BFQu\u00E9 tengo que hacer despu\u00E9s de recibir mi LLC?',
        faq_13_a: 'Cuatro cosas b\u00E1sicas: (1) Abrir una cuenta de banco empresarial con tu EIN y certificado. (2) Presentar el Reporte de Informaci\u00F3n P\u00FAblica ante el Comptroller de Texas \u2014 es gratis, una vez al a\u00F1o. (3) El franchise tax \u2014 la mayor\u00EDa de LLCs peque\u00F1as no deben nada. (4) Mantener tu agente registrado activo. Con el plan Completo, te damos una gu\u00EDa personalizada con todos estos pasos explicados.',
    ...
    en: {
        ...
        problem_2_desc: 'You opened the state website, saw \u201CCertificate of Formation,\u201D and closed the tab. You\u2019re not alone.',
        ...
        step_1_desc: 'Message us on WhatsApp or fill out the form on this page. We respond within 1 business day.',
        step_2_title: 'Confirmation call',
        step_2_desc: 'We review your information, answer your questions, and securely collect sensitive details.',
        ...
        faq_11_q: 'Will having an LLC affect my family\u2019s taxes?',
        faq_11_a: 'A single-member LLC in Texas doesn\u2019t change how you file your federal taxes \u2014 it\u2019s reported on your personal return, same as before. And Texas state franchise tax? Most small LLCs owe nothing: $0. If you have specific questions about your tax situation, we recommend consulting with an accountant.',
        faq_12_q: 'What\u2019s the difference between LLC and DBA? Which one do I need?',
        faq_12_a: 'An LLC is a legal entity \u2014 it protects your personal assets and gives you an EIN to open a bank account and receive formal payments. A DBA (assumed name) is just a business name, it doesn\u2019t give you legal protection. Most of our clients need the LLC first. If your business operates under a different name than your LLC, then you also need a DBA. Example: your LLC is \u201CMaria Garcia LLC\u201D but you sell as \u201CDelicias de Maria\u201D \u2014 you need both.',
        faq_13_q: 'What do I need to do after I get my LLC?',
        faq_13_a: 'Four basic things: (1) Open a business bank account with your EIN and certificate. (2) File the Public Information Report with the Texas Comptroller \u2014 it\u2019s free, once a year. (3) Franchise tax \u2014 most small LLCs owe nothing. (4) Keep your registered agent active. With the Complete plan, we give you a personalized guide with all these steps explained.',
